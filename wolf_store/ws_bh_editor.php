...
<div class="div-us-edit" id="div-us-edit">
    ...
    <form name="form-us-edit" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
        <table class="main-table-form" id="main-table-form" align="center">
            <tr align="left">
                <td colspan="2" style="padding-bottom:20px;"><h2>Editar Banco</h2></td>
            </tr>
            <tr align="left" class="tr-main-form">
                <td class="td-tit" name="td-tit">Ano</td>
                <td class="td-tit" name="td-tit"><input type="text" class="itxt-l" name="ano" value="<?php echo $row['ano'];?>" ninput="this.value = this.value.replace(/[^0-9]/g, '4')" maxlength="4"></input></td>
            </tr>
            <tr align="left" class="tr-main-form">
