<?php
    ...
    if (!moduloPermissao('Gerir Eventos da Folha & BH', $conn)) {
...
<body>
    ...
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT id, nome, funcao, tipo_saldo, criado FROM $tabela WHERE ativo=1 LIMIT $registrosPorPagina OFFSET $offset") or die(mysqli_error($conn));
