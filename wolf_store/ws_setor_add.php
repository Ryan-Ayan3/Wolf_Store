...
<div class="div-us-create" id="div-us-create">
    <ul class="breadcrumb">
        <li><a href="" onclick="voltarPagina()"><span class="icon-start"></span>Setores</a></li>
    ...
    <form name="form-us-create" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST" onkeydown="return event.key != 'Enter';">
        <table class="main-table-form" id="main-table-form" align="center">
            <tr align="left">
                <td colspan="2" style="padding-bottom:20px;"><h2>Criar Setor</h2></td>
            </tr>
            <tr align="left" class="tr-main-form">
                <td class="td-tit" name="td-tit">Nome</td>
                <td class="td-tit" name="td-tit"><input type="text" class="itxt-l" name="nome" placeholder="Nome do Setor" required></input></td>
            </tr>
            <tr align="center">
                <td colspan="2">
