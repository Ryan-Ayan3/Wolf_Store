<?php
    ...
    if (!moduloPermissao('Aquisição de Produto', $conn)) {
...
<body>
    ...
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT 
                                        a.id, a.fornecedor_cod, a.fornecedor_nome, data_entregue, a.preco_total, 
                                        p.id
                                    FROM 
                                        $tabela a, aquisicao_prod p
                                    WHERE 
                                        a.ativo=1 and
                                        p.ativo=1 and
                                        a.id = p.fk_aquisicao
    ...
    <div class="conteudo">
        <ul class="breadcrumb">
            <li><a href="#" onclick="voltarPagina()"><span class="icon-start"></span>Aquisições</a></li>
        </ul>
