<?php
    ...
    if (!moduloPermissao('Tipos de Movimentação', $conn)) {
...
<body>
    ...
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT id, nome, tipo FROM $tabela WHERE ativo=1 LIMIT $registrosPorPagina OFFSET $offset") or die(mysqli_error($conn));
