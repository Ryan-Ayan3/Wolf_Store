<?php
    ...
    if (!moduloPermissao('Unidades de Medidas', $conn)) {
...
<body>
    ...
    <?php
        ...
        $sql = mysqli_query($conn, "SELECT id, nome, tipoValor FROM $tabela WHERE ativo=1 LIMIT $registrosPorPagina OFFSET $offset") or die(mysqli_error($conn));

    ?>
    <div class="conteudo">
        <ul class="breadcrumb">
            <li><a href="#" onclick="voltarPagina()"><span class="icon-start"></span>Unidades de Medidas</a></li>
        </ul>
